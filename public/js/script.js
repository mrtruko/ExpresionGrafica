...
var App = function () {
	...
	var handleBootbox = function () {
		...
		$(".multiple-buttons").click(function(){
			bootbox.dialog({
			message: "Ingrese Codigo" +'<input type="text" class="form-control" name="email" placeholder="Por favor ingrese un email"/>'+"Ingrese Codigo" +'<input type="text" class="form-control" name="email" placeholder="Por favor ingrese un email"/>',
			title: "Custom title",
			buttons: {
				success: {
					label: "Guardar",
